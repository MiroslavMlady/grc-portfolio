...
Hands-on governance, risk and compliance projects built around a fictional Slovak SME (SLOVPACK s.r.o., a packaging manufacturer with 45 employees).
...
Investigation of a simulated phishing email delivering the Agent Tesla information-stealing Trojan: email forensics, SPF/spoofing detection, malware triage (VirusTotal, Tria.ge), MITRE ATT&CK mapping and IOCs. Where the ISO 27001 lab defines the controls for phishing risk, this case study shows how such an attack is actually investigated.
